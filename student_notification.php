        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					if ($read_row !== null && array_key_exists('student_read', $read_row)) {
						$yes = $read_row['student_read'];
					} else {
						// Handle the case where $read_row is null or 'student_read' doesn't exist
						// For example, you could set a default value:
						$yes = 0; // Assuming 0 is the default value for student_read
					}
